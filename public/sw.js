 ...
 *
 * 2026-05-25: v3 — CDN cache-bust rename. sw-v3.js is the canonical file.
 * sw.js redirects all registrations to sw-v3.js on next activation.
 */
const CACHE_NAME = 'swell-v3';

// Upgrade path: self-replace so old sw.js installs redirect to sw-v3.js
